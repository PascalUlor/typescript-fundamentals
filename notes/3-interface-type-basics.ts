...
let dumInt: HasInternationalPhoneNumber = { countryCode: 'US', name: 'Haja', phone: 55555555}
...
const user: ContactMessenger2 = (Dcontact, Dmessage) => {
  /** ... */
};
